...
public interface OrganizationService {
  ...
  /**
   * Thêm reader (qua email) vào organization (orgId dạng UUID string). - Idempotent: nếu đã là
   * member thì bỏ qua; - Nếu tồn tại bản ghi membership nhưng inactive/pending -> kích hoạt
   * ACTIVE.
   */
