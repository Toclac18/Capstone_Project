...
interface DocumentStatisticsTabProps {
  state: LoadState;
  statistics: GlobalDocumentStatistics | null;
  error: string | null;
}

export function DocumentStatisticsTab({
  state,
  statistics,
  error,
}: DocumentStatisticsTabProps) {
  if (state === "loading") {
    return (
  ...
  // Summary Cards
  const summaryCards = [
    { title: "Total Documents", value: statistics.summary.totalDocuments },
    { title: "Total Views", value: statistics.summary.totalViews },
    { title: "Total Upvotes", value: statistics.summary.totalUpvotes },
    { title: "Total Comments", value: statistics.summary.totalComments },
    { title: "Total Saves", value: statistics.summary.totalSaves },
    { title: "Total Purchases", value: statistics.summary.totalPurchases },
  ];
  ...
  const statusOptions: ApexOptions = {
    ...
    title: {
      text: "Document Status Breakdown",
      style: { fontSize: "16px", fontWeight: 600 },
    },
