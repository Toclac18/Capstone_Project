...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleAuthDenied(
    ...
    public ResponseEntity<ProblemDetail> handleValidation(
        ...
        return buildProblemDetail(
                HttpStatus.UNPROCESSABLE_ENTITY, "Validation Error", msg, "VALIDATION_ERROR", req);
    }
    ...
    public ResponseEntity<ProblemDetail> handleBadRequest(Exception ex, HttpServletRequest req) {
        return buildProblemDetail(
                HttpStatus.BAD_REQUEST, "Bad Request", ex.getMessage(), "BAD_REQUEST", req);
    }
