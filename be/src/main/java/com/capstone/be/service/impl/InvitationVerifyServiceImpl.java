...
/**
 * Verify invitation token: - Xác thực/giải mã token bằng JwtUtil (issuer + chữ ký + hạn dùng
 * "exp"). - Nếu reader tồn tại -> join org + đánh dấu invitation accepted. - Nếu chưa -> chỉ ghi
 * nhận verifiedAt; controller sẽ redirect tới trang đăng ký.
 */
@Service
...
public class InvitationVerifyServiceImpl implements InvitationVerifyService {
  ...
  @Override
  @Transactional
  public boolean handleVerification(String orgIdFromUrl, String emailFromUrl, String token,
