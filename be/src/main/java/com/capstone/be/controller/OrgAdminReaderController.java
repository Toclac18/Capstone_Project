...
public class OrgAdminReaderController {
    ...
    /**
     * Lấy danh sách Reader (phân trang + tìm kiếm + filter trạng thái)
     * Chỉ cho phép admin có ORGANIZATION
     */
    @GetMapping("/readers")
    ...
    public ResponseEntity<Page<ReaderResponse>> getReaders(
        ...
        Page<ReaderResponse> readers = (Page<ReaderResponse>) readerService.getReaders(page, pageSize, q, status);
